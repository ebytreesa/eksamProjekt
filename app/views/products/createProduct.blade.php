...
<div class="container">
    ...
    {{ Form::open(array('route' => 'postCreateProduct', 'class' => 'form-horizontal','id' => 'createProduct-form', 'files' => true)) }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8 col-md-9 ">
                 <textarea type="textarea" id="description" name="description" class="form-control" rows="5" cols="40"></textarea>
            </div>
             <div class="col-sm-2 col-md-2"></div>
        </div>
